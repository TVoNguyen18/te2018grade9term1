...
// function usrDecidePrinting() {
//   let print = READLINE.question("Do you want to print the message once or five times? ");
//   if (print == "1") {
//     message();
//   } else if (print == "5") {
//     printMessage5Times();
//   } else {
//     console.log("You have to enter either 1 or 5! Is it so hard???");
//   }
// }
//
// usrDecidePrinting();
...
function parrotTrouble(isTalking, hour) {
  if (isTalking == true && (hour < 7 || hour > 20)) {
    return true;
  } else if (isTalking == true && (hour > 7 && hour < 20)) {
    return false;
  } else {
    return false;
  }
